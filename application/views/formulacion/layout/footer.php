...
<script>
	...
	if(counter > 0){
		...
		$("#Fases").append("<div id='referencia" + (counter + 1) +"'> " +
			"<div class='form-group'><label for='idDetalleEtapa'>" + (counter + 1) + ":</label> " +
	...
	if(counter2 > 0){
		$("#Ingrediente").append("<div id='referencia2" + (counter2 + 1) +"'>" +
					"<div class='form-group'><label for='idIngrediente'>"+ (counter2 + 1) +":</label> " +
					"<select id='idIngrediente" + (counter2 + 1) +"' class='form-control' name='idIngrediente[]' data-ingrediente=" + (counter2 + 1) + "'>" + ingrediente + "</select></div><div class='form-group'> " +
		...
		counter2++;
			...
			$("#Ingrediente").append("<div id='referencia2" + (counter2 + 1) +"'><div class='form-group'><label for='idIngrediente'>"+ (counter2 + 1) +":</label> " +
					"<select id='idIngrediente" + (counter2 + 1) +"' class='form-control' name='idIngrediente[]' data-ingrediente=" + (counter2 + 1) + "'>" + ingrediente + "</select></div><div class='form-group'> " +
					"<label for='PrecioIngrediente'>Precio:</label><input required id='PrecioIngrediente' class='form-control' type='text' size='30' maxlength='30' name='PrecioIngrediente[]'> " +
					"</div><div class='form-group'><label for='idEspecificacion'>Especificacion:</label> " +
	...
	if(counter3 > 0){
		$("#Forraje").append("<div id='referencia3" + (counter3 + 1) +"'>" +
					"<div class='form-group'><label for='idForraje'>" + (counter3 + 1) +"</label> " +
					"<select id='idForraje" + (counter3 + 1) +"' class='form-control' name='idForraje[]'>" + forraje + ":</select></div><div class='form-group'> " +
		...
		counter3++;
			...
			$("#Forraje").append("<div id='referencia3" + (counter3 + 1) +"'><div class='form-group'><label for='idIngrediente'>" + (counter3 + 1) +":</label> " +
					"<select id='idForraje" + (counter3 + 1) +"' class='form-control' name='idForraje[]'>" + forraje + "</select></div><div class='form-group'> " +
					"<label for='PrecioIngrediente'>Precio:</label><input required id='PrecioForraje' class='form-control' type='text' size='30' maxlength='30' name='PrecioForraje[]'> " +
