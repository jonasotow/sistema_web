	  ...
	  <?php
			...
			<table class="table table-striped table-hover table-condensed">
				 <thead>
					<tr>
						...
						<th><i class="fa fa-list-alt fa-lg"></i></th>
						<th></th>
					</tr>
				 </thead>
				 <tbody>
		...
		?>
					<tr>
						...
						<td>
							<?=$factura[$key] = !empty($factura[$key]) ?  $factura[$key] : 'Cancelada' ?>
						</td>
						<td>
						<?php if ($factura[$key] !== 'Cancelada') { ?>
						
							<a href="<?=site_url('pasos/factura_pdf_xml/'.$factura[$key]); ?>" target="_blank" class="td">
...
<!-- Modal aria-labelledby="detalleOrdenModal"-->
