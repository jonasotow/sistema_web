...
class Micro_Model extends My_Model {
    public $table_name;
    public $schema;
    public $schema_add;
    public $schema_up;
    ...
    function prepararForm(){
        $forms = array();
        $subespecie = $this->get('Subespecie','idSubespecie,Subespecie');
        $forms[0] = 'Seleccione una Subespecie';
        foreach($subespecie as $row){
            $forms[$row->idSubespecie] = $row->Subespecie;
        }
        $this->schema['Micro']['idSubespecie']['data'] = $forms;
    }
